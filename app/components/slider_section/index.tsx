...
export const SliderSection = (props: SliderSectionProps) => {
  ...
  return <div className={CN(props.className,"h-[1000px]","bg-[url('/slider_section_bg.png')]", "bg-cover",  "flex", "border-b border-bg_1_50", "bg-grey")}>
    <div className={CN("container", "flex", "flex-row", "pt-36 pb-16")}>
      <div className={CN("w-1/2", "flex", "flex-col", "justify-between")}>
        <div className={CN("flex", "flex-col", "w-full", "h-[100%] justify-between")}>
          <div className={CN("flex", "flex-row", "")}>
            <div className={CN("flex", "flex-col", "items-start", currentSlide != 1 && "d-none")}>
              <h1 className={CN("mb-4 ", "w-[747px]", "text-[64px] font-medium leading-[83.2px] font-Involve text-bg_1_100")}>
      ...
      <div className={CN("w-1/2", "flex", "flex-col", "items-end")}>
        <div className={CN("flex", "flex-row")}>
          <div className={CN("w-[272px]", "h-[272px]", "bg-accent_2_600", "p-6", "flex", "flex-col", "justify-between")}>
            <h5 className={CN("mb-0 font-Gilroy font-extrabold text-[22px] text-bg_1_100")}>Оформление рассрочки по ставке от 15% годовых</h5>
            <div className={CN("flex", "flex-row")}>
          ...
          <div className={CN("w-[272px]", "h-[272px]", "bg-[url('/barn.png')]", "bg-cover", "p-6")}>
            <h5 className={CN("mb-0 font-Gilroy font-extrabold text-[22px] text-bg_1_100")}>Барнхаусы</h5>
          </div>
        </div>
        <div className={CN("flex", "flex-row")}>
        <div className={CN("w-[272px]", "h-[272px]", "bg-[url('/town.png')]", "bg-cover", "p-6")}>
            <h5 className={CN("mb-0 font-Gilroy font-extrabold text-[22px] text-bg_1_100")}>Таунхаусы</h5>
          </div>
          <div className={CN("w-[272px]", "h-[272px]", "bg-accent_2_600", "p-6", "flex", "flex-col", "justify-between")}>
            <h5 className={CN("mb-0 font-Gilroy font-extrabold text-[22px] text-bg_1_100")}>Скидка до 5% при полной предоплате за проект</h5>
            <div className={CN("flex", "flex-row")}>
              <a href="#" className={CN("flex", "flex-row", "mr-1", "leading-5", "text-lg", "text-bg_1_100", "font-normal", "no-underline")}>
              Подробнее
              </a> 
